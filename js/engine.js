 ...
 * o caso. O que realmente ocorre é que toda a "cena" está sendo desenhada
...
var Engine = (function(global) {
    ...
    const statusBars = (nLifes) => {
        ...
        for (let i = 0; i < nLifes; i++) {
            let elem = document.createElement("img");
            elem.className = 'hearts';
            elem.src = 'images/heart2.png';
            document.getElementById('life').appendChild(elem);
        }
    }
